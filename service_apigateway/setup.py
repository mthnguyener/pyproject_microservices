...
with open('service_apigateway/__init__.py', 'r') as fd:
...
setup(
    ...
    package_dir={'service_apigateway': 'service_apigateway'},
    include_package_data=True,
    entry_points={'console_scripts': [
        'count=service_apigateway.cli:count',
    ]})
